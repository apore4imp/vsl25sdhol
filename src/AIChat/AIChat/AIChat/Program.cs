...
builder.Services.AddSqliteCollection<string, IngestedChunk>("data-aichat-chunks", vectorStoreConnectionString);
builder.Services.AddSqliteCollection<string, IngestedDocument>("data-aichat-documents", vectorStoreConnectionString);
